...
//     * 服务端 --> 客户端
//     */
//    public static final String SERVER_TO_CLIENT = "s2c/";
//    /**
//     * 客户端 --> 服务端
//     */
//    public static final String CLIENT_TO_SERVER = "c2s/";
//
//    @Bean
...
//                new MqttPahoMessageDrivenChannelAdapter(String.format(addressFormat, brokerHost), UUID.randomUUID().toString(), mqttClientFactory(),CLIENT_TO_SERVER + "#");
